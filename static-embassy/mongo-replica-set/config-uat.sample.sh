...
export MONGO_PASSWORD=`echo -n <UAT_MONGO_ADMIN_PASSWORD> | base64` #secret
export APP_USER=`echo -n "atlas" | base64`
export APP_PASSWORD=`echo -n <UAT_MONGO_APP_PASSWORD> | base64` #secret
export MONGO_KEY=`echo -n <UAT_MONGO_KEY> | base64` #secret
