...
export ATLAS_AUTH_CLIENT_SECRET=`echo -n <UAT_ATLAS_AUTH_CLIENT_SECRET> | base64` #secret
...
export NEO4J_AUTH=`echo -n <UAT_NEO4J_AUTH> | base64` #secret
export DISTANCE_API_NEO4J_AUTH=`echo -n <UAT_DISTANCE_API_NEO4J_AUTH> | base64` #secret

export TRACKING_DB_USER="postgres"
export TRACKING_DB_PASSWORD_RAW="password"
export TRACKING_DB_PASSWORD=`echo -n <UAT_TRACKING_DB_PASSWORD> | base64` #secret
...
export TRACKING_DB_URI=`echo -n <UAT_TRACKING_DB_URI> | base64` #secret
