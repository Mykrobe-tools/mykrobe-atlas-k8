...
export ATLAS_AUTH_SERVER="https://accounts.mykro.be/auth"
export ATLAS_AUTH_CLIENT_ID="analysis-api"
export ATLAS_AUTH_CLIENT_SECRET=`echo -n <PROD_ATLAS_AUTH_CLIENT_SECRET> | base64` #secret
...
export NEO4J_AUTH=`echo -n <PROD_NEO4J_AUTH> | base64` #secret
export DISTANCE_API_NEO4J_AUTH=`echo -n <PROD_DISTANCE_API_NEO4J_AUTH> | base64` #secret

export TRACKING_DB_USER="postgres"
export TRACKING_DB_PASSWORD_RAW="password"
export TRACKING_DB_PASSWORD=`echo -n <PROD_TRACKING_DB_PASSWORD> | base64` #secret
...
export TRACKING_DB_URI=`echo -n <PROD_TRACKING_DB_URI> | base64` #secret
