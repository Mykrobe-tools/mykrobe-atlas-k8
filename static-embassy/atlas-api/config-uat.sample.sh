...
export MONGO_PASSWORD=`echo -n <UAT_MONGO_APP_PASSWORD> | base64` #secret

export AWS_ACCESS_KEY=`echo -n <UAT_ACCESS_KEY> | base64` #secret
export AWS_SECRET_KEY=`echo -n <UAT_SECRET_KEY> | base64` #secret
...
export ES_PASSWORD=`echo -n <UAT_ES_PASSWORD> | base64` #secret
...
export KEYCLOAK_ADMIN_PASSWORD=`echo -n <UAT_KEYCLOAK_ADMIN_PASSWORD> | base64` #secret
