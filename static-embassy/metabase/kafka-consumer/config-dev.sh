...
export BROKER_URL="http://mykrobe-bitnami-kafka-headless.insight-dev.svc.cluster.local:9092"
export SCHEMA_REGISTRY_URL="http://mykrobe-bitnami-schema-registry.insight-dev.svc.cluster.local:8081"
