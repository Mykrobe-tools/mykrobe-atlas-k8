...
export CONSUMER_IMAGE="eu.gcr.io/atlas-275810/mykrobe-atlas-kafka-consumer:v0.0.8"
export APP_NAME="kafka-consumer"
export BROKER_URL="http://mykrobe-confluent-kafka.insight-dev.svc:9092"
export SCHEMA_REGISTRY_URL="http://mykrobe-confluent-schema-registry.insight-dev.svc:8081"
