...
# Endpoint of the API
export REACT_APP_API_URL="https://api-uat.mykro.be"

# Swagger spec if available
export REACT_APP_API_SPEC_URL="https://api-uat.mykro.be/swagger.json"

# If using Keycloak
export REACT_APP_KEYCLOAK_URL="https://accounts-uat.mykro.be/auth"
